...
<!-- Section heading -->
<div class="container ">
 <h3 class="h1-responsive font-weight-bold my-5 border-bottom team-sec-title font-2 py-3">CREATE SERIES</h2>
</div>
    ...
    <div class="row">
        ...
        <div class="col-6 border border-secondary">
            ...
            <p class="display-6">SERIES TITLE</p>
                <input type="text" class="form-control {{ $errors->has('name') ? 'has-error' : '' }}" id="InputName" name="seriesName" placeholder="series name" value="{{ old('seriesName') }}">
            </div>
            ...
            <div class="form-group m-5">
                <select id="inputRole" class="form-control font-color-black {{ $errors->has('role_id') ? 'has-error' : '' }}" name="seriesSpeaker">
                    ...
                    <option class="font-color-black" value="{{$speaker->id}}">{{$speaker->firstname . ' ' . $speaker->surname}}</option>
                    @empty
        ...
        <div class="col-6 border border-secondary">
            <div class="form-check m-5">
                ...
                <div class="row">
                    <input type="checkbox" class="form-check-input" name="seriesEpisodesId[]" value="{{$episode->id}}" id="seriesEpisodeCheckbox">
